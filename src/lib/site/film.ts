...
export const DEFAULT_FILM: LandingFilm = {
	...
	tiles: {"industry:turo": clip(4208203, 24),"industry:doordash": clip(4168426, 25),"industry:hospitality": clip(7820478, 25),"industry:fleet": clip(5834188, 24),"industry:property": clip(4877217, 30),"industry:services": clip(8986482, 30),"industry:small": clip(7697073, 30),"industry:startups": clip(8266178, 25),"solution:va": clip(8865706, 25),"solution:turo-ops": clip(4208203, 24),"solution:doordash-ops": clip(7362583, 24),"solution:consulting": clip(7413764, 24),"solution:webapps": clip(8266178, 25),"solution:websites": clip(4177954, 30),"solution:crm": clip(3986119, 25),"solution:dashboards": clip(8064422, 30),"solution:automation": clip(8094279, 25),"solution:integrations": clip(20693196, 25),"solution:workflow": clip(8986890, 30),"solution:analytics": clip(6868699, 30),"solution:bi": clip(6685171, 30),"problem:1": clip(8094279, 25),"problem:2": clip(4208203, 24),"problem:3": clip(3986119, 25),"problem:4": clip(4177954, 30),"problem:5": clip(7413764, 24),"problem:6": clip(8064422, 30),"pillar:people": clip(8865706, 25),"pillar:systems": clip(7413764, 24),"pillar:software": clip(8266178, 25),"week:1": clip(7413764, 24),"week:2": clip(8266178, 25),"week:3": clip(8865706, 25),"week:4": clip(6868699, 30),"proof:1": clip(4208203, 24),"proof:2": clip(3986119, 25),"proof:3": clip(8064422, 30)},
	testimonials: [{"quote":"HostOS Collective completely transformed how we handle online orders. Our operations are smoother, and we’ve seen a 30% boost in repeat customers since launching the new system.","name":"Zack Holmes","role":"Restaurant owner","photo":"https://images.pexels.com/photos/3760046/pexels-photo-3760046.jpeg?auto=compress&cs=tinysrgb&w=160&h=160&fit=crop"},{"quote":"From building our website to setting up automated email campaigns, HostOS Collective delivered everything on time and on budget. Truly a one-stop shop for growing businesses.","name":"Miguel Chavez","role":"E-commerce startup","photo":"https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=160&h=160&fit=crop"},{"quote":"Having a dedicated VA team that manages my fleet bookings and guest communication has been a game changer. Professional, reliable, and always responsive.","name":"Matt Tolley","role":"Turo host","photo":"https://images.pexels.com/photos/6333501/pexels-photo-6333501.jpeg?auto=compress&cs=tinysrgb&w=160&h=160&fit=crop"}],
...
export function normalizeFilm(raw: unknown): LandingFilm {
	...
	return { hero: { src: isFilmSrc(heroSrc) ? heroSrc : DEFAULT_FILM.hero.src }, chapters, extras: { team: extra("team"), delivery: extra("delivery"), closing: extra("closing") }, tiles, sections, testimonials, laurels };
}
