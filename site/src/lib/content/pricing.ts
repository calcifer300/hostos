...
export const CUSTOM_LINE = 'Custom pricing based on project scope, technical requirements, integrations, complexity, timeline and business goals.';
...
export const SERVICES: Service[] = [
	{
		...
		included: ['Operators trained by the Founder, 5+ yrs VA & BPO each', 'Procedures written for your business, one page each', 'Coverage as a team, never a single person', 'Weekly numbers, monthly review', 'Quality checks on every conversation'],
	...
	},
	{
		...
		included: ['Design and build in-house', 'Mobile-first, Lighthouse-tested', 'Booking, quote or contact flows', 'Technical SEO, schema, sitemap', 'Your domain, your accounts, your code'],
	...
	},
	{
		...
		included: ['Discovery and scope', 'UI design', 'Authentication and roles', 'Integrations with the tools you run on', 'Testing on real devices'],
	...
	},
	{
		...
		included: ['Audit of the repetitive work', 'Assistants built for your procedures', 'Human-in-the-loop approvals', 'Monitoring and monthly tuning'],
	...
	},
	{
		...
		included: ['Pipeline design', 'Data migration', 'Automated reminders and follow-ups', 'Portals for clients and staff', 'Team training'],
	...
	},
	{
		...
		included: ['Technical audit and fixes', 'Google Business Profile management', 'Monthly content', 'Review responses', 'Monthly report you can read in five minutes'],
