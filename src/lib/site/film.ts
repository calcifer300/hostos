...
export const DEFAULT_FILM: LandingFilm = {
	...
	copy: {
		hero: { eyebrow: "For car rental fleets · restaurants · field services · shops", line1: "Run the business.", line2: "We’ll run the *operations*.", body: "We handle the rest behind the scenes so you can focus on what matters. AI where it helps, humans where it matters — from customer support to daily operations, experienced operators and AI work together so you don’t have to." },
		sections: {},
