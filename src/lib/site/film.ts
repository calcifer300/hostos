...
export const DEFAULT_FILM: LandingFilm = {
	...
	copy: {
		hero: { eyebrow: "For car rental fleets · restaurants · field services · shops", line1: "Focus on what matters most.", line2: "We’ll handle your *operations*.", body: "AI where it helps. Humans where it matters. From customer support to daily operations, we combine intelligent automation with experienced operators so you can focus on growing your business." },
		sections: {},
