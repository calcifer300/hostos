 ...
 *
 * Names match what the host already uses: Unverified Licences, Profit Risk and
 * Earnings Estimator.
 */
    ...
    <div className="mx-auto w-full max-w-3xl">
      <div className="mb-8">
        ...
        <p className="mt-1 text-[14px] leading-relaxed text-muted-foreground">
          The two rules this fleet runs on — verify a licence before pickup, and catch a trip worth
      ...
      <Section
        icon={ShieldAlert}
        title="Unverified licences"
        description="Guests can't upload a licence until 24 hours before pickup, so only trips inside that window are listed — flagging earlier is a false alarm."
        count={queues.licenses.length}
        empty="Every guest picking up in the next 24 hours has a verified licence."
      >
