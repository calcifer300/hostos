...
- **Twelve portraits** in `public/team/<slug>.jpg`: full 4:5 frames
  (900×1125) from the studio set, lighting and colour matched to one
  reference frame with a touch of grain so they read as a single shoot
  (`scripts/team-photos.mjs <source-dir> public/team`). Tiles on /team and
