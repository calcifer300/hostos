...
| 15 | **`vendor/` weight in the repo** | `vendor/cc-extension`, bundles | Kept as the audit's evidence and for reference | Move to a separate archive repo once Karl has reviewed the audit. |
