import { Blocks, Car, ChefHat, Coffee, Globe, Scissors, ShoppingBag, Wrench, type LucideIcon } from "lucide-react";
import type { ModuleIcon as ModuleIconName } from "@/lib/modules";

/** The one place a module's icon name becomes a component. */
export const MODULE_ICONS: Record<ModuleIconName, LucideIcon> = { Car, ChefHat, ShoppingBag, Wrench, Globe, Coffee, Scissors, Blocks };
